    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <table class="table table-hover">
            <tr style="background-color: whitesmoke">
                <th style="text-align: center" colspan="2">Tabela de Vendedores</th>
            </tr>
            <tr style="background-color: whitesmoke">
                <th>Nome</th>
                <th>Ação</th>
            ...
            if (isset($_POST['acao'])) {
                ...
                if ($acao == "ativar") {
                    ativarVendedor($codigoVendedor);
                }
                if ($acao == "desativar") {
                    desativarVendedor($codigoVendedor);
                }
            }
            ...
            foreach ($vendedores as $vendedor) {
                ...
                echo    '<td>';
                if ($vendedor->getAtivado()) {
                    echo "<form action='?' method='POST'>";
                    echo    "<input type='hidden' name='codigoVendedor' value='{$vendedor->getCodigo()}'/>";
